...
const deals = [
  { store:'BloomChic', name:'Textured Long Cardigan', regular:49.90, sale:18.99, discount:62, size:'3X / 22–24', match:91, reason:'Works with 5 owned pieces', badge:'Strong Buy', level:'strong', category:'Layers', subcategory:'Cardigans', occasion:['Church','Everyday'], season:['Fall','Winter'], verified:true, newDeal:true, priceDrop:true, lowestSeen:true, image:'/placeholders/layers.svg' },
  { store:'Maurices', name:'Soft V-Neck Blouse', regular:39.90, sale:14.95, discount:63, size:'3X', match:89, reason:'Everyday + church crossover', badge:'Strong Buy', level:'strong', category:'Tops', subcategory:'Blouses', occasion:['Church','Everyday'], season:['Year-Round'], verified:true, newDeal:true, priceDrop:false, lowestSeen:false, image:'/placeholders/tops.svg' },
  { store:'Torrid', name:'Ponte Straight Pant', regular:79.90, sale:23.99, discount:70, size:'24', match:96, reason:'High-priority bottom', badge:'Exceptional', level:'exceptional', category:'Bottoms', subcategory:'Ponte / Knit Pants', occasion:['Church','Everyday'], season:['Year-Round'], verified:true, newDeal:false, priceDrop:true, lowestSeen:true, image:'/placeholders/bottoms.svg' },
  { store:'ELOQUII', name:'Soft Wrap Midi Dress', regular:99.95, sale:29.99, discount:70, size:'24', match:90, reason:'Versatile church + dinner dress', badge:'Exceptional', level:'exceptional', category:'Dresses', subcategory:'Church / Versatile Dresses', occasion:['Church','Date Night'], season:['Fall','Spring'], verified:true, newDeal:true, priceDrop:true, lowestSeen:false, image:'/placeholders/dresses.svg' },
  { store:'Lane Bryant', name:'Wireless Lift & Shape Bra', regular:59.95, sale:24.98, discount:58, size:'50D', match:88, reason:'Needed lift & shape category', badge:'Strong Buy', level:'strong', category:'Intimates', subcategory:'Lift & Shape Bras', occasion:['Church','Date Night'], season:['Year-Round'], verified:true, newDeal:false, priceDrop:true, lowestSeen:true, image:'/placeholders/intimates.svg' },
  { store:'Old Navy', name:'High-Waisted PowerSoft Leggings', regular:44.99, sale:19.99, discount:56, size:'24', match:85, reason:'High-priority gym bottom', badge:'Strong Buy', level:'strong', category:'Active', subcategory:'Workout Leggings', occasion:['Gym'], season:['Year-Round'], verified:true, newDeal:true, priceDrop:false, lowestSeen:false, image:'/placeholders/active.svg' },
  { store:'Kohl’s', name:'Everyday Slip-On Sneaker', regular:64.99, sale:29.99, discount:54, size:'9.5', match:82, reason:'Everyday shoe gap', badge:'Strong Buy', level:'strong', category:'Shoes', subcategory:'Slip-Ons', occasion:['Everyday','Errands'], season:['Year-Round'], verified:true, newDeal:false, priceDrop:true, lowestSeen:false, image:'/placeholders/shoes.svg' },
  { store:'JCPenney', name:'Soft Knit Pajama Set', regular:52.00, sale:19.99, discount:62, size:'3X', match:84, reason:'High-priority sleepwear gap', badge:'Strong Buy', level:'strong', category:'Lounge', subcategory:'Pajama Sets', occasion:['Lounge'], season:['Fall','Winter'], verified:true, newDeal:true, priceDrop:true, lowestSeen:true, image:'/placeholders/lounge.svg' },
  { store:'Torrid', name:'Everyday Crossbody Bag', regular:49.90, sale:17.49, discount:65, size:'One Size', match:86, reason:'High-priority accessory gap', badge:'Strong Buy', level:'strong', category:'Accessories', subcategory:'Crossbody Bags', occasion:['Everyday','Church'], season:['Year-Round'], verified:true, newDeal:true, priceDrop:false, lowestSeen:false, image:'/placeholders/accessories.svg' },
  { store:'BloomChic', name:'Ruched One-Piece Swimsuit', regular:49.90, sale:14.99, discount:70, size:'3X', match:70, reason:'Low-priority wildcard', badge:'Wildcard', level:'strong', category:'Swim', subcategory:'One-Piece', occasion:['Swim'], season:['Summer'], verified:true, newDeal:false, priceDrop:true, lowestSeen:true, image:'/placeholders/swim.svg' }
]
